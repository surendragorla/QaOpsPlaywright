...
> 9  |         return await this.page.locator(".header-menu .top-menu a[href='/books']").isVisible();
     |                                                                                   ^ Error: locator.isVisible: Test ended.
  10 |     }
  11 |     async isComputersVisible() {
  12 |         return await this.page.locator(".header-menu .top-menu a[href='/computerss']").isVisible();
  13 |     }
